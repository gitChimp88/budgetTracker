...
export default class ShakesTwo extends React.Component {
	constructor(){
		super()
		this.state = {
    ...
    return (
        ...
        <div >
          ...
          <Transition animation={animation} duration={duration} visible={visible}>
				<img style={cursor} onClick={this.toggleVisibility.bind(this)} height="100" width="100" src="/images/bills.png"></img>
			  </Transition>
		     <p>Bills</p>
		  </div>
